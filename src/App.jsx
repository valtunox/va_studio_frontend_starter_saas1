/**
 * VA Studio Frontend — SaaS One Standalone
 *
 * This is a standalone version of the SaaS One template.
 * It renders the SaaS One template directly as the main interface.
 *
 * Routes:
 *   /  → SaaS One template (default)
 *
...
import TemplateApp from '../templates/saas1/App.jsx'
...
/* ------------------------------------------------------------------ */
/*  Home Page (SaaS One Template with Connectivity Banner)       */
/* ------------------------------------------------------------------ */
